...
function DesktopPinboardView(props: {
  ...
  const boardGroups = [unassignedGroup, ...pinboardGroups].filter(Boolean) as BoardGroup[]
  ...
  return (
    <section className="desktop-pinboard h-100 d-flex flex-column gap-3 min-h-0">
      <div className="desktop-stage-header card border-0 shadow-sm flex-shrink-0">
        <div className="card-body p-3 p-lg-4 d-flex flex-column flex-xxl-row align-items-start align-items-xxl-center justify-content-between gap-3">
          <div className="desktop-top-copy">
            ...
            <h2 className="h3 mb-1">Gruppen</h2>
            <p className="desktop-subtitle mb-0">„Nicht zugeordnet“ wird wie jede andere Gruppe als eigene Spalte behandelt.</p>
          </div>
      ...
      {props.loading ? (
        ...
        <div className="desktop-pinboard-layout flex-grow-1 min-h-0 d-flex gap-0">
          <div className="desktop-pinboard-surface flex-grow-1 min-w-0 overflow-auto">
            {boardGroups.length === 0 ? (
              <div className="alert alert-light border shadow-sm mb-0">Noch keine Gruppen vorhanden. Über „Neu gruppieren“ wird die Fläche automatisch gefüllt.</div>
            ) : (
